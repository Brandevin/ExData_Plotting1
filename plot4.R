...
plot(df$DatetimeHour,df$Global_active_power, type="l", col="black", lwd=1,ylab="Global Active Power",xlab='')
plot(df$DatetimeHour,df$Voltage, type="l", col="black", lwd=1,ylab="Voltage",xlab='datetime')
...
plot(df$DatetimeHour,df$Global_reactive_power, type="l", col="black", lwd=1,ylab="Global_reactive_power",xlab='datetime')
